        ...
        <div className="row">
          <div className="col-12">
            <div className="policy">
              ...
              <p>
                CreativeShoppingHub website is owned by MinovaEdge Softtech Pvt
                Ltd, which is a data controller of your personal data.
              </p>

              <p>
                We have adopted this Privacy Policy, which determines how we are
                processing the information collected by CreativeShoppingHub,
                which also provides the reasons why we must collect certain
                personal data about you. Therefore, you must read this Privacy
                Policy before using CreativeShoppingHub website.
              </p>
              ...
              <p>
                When you visit the CreativeShoppingHub, we automatically collect
                ...
                the Site, we collect information about the individual web pages
                or products you view, what websites or search terms referred you
                to the Site, and how you interact with the Site. We refer to
                this automatically-collected information as “Device
                Information.” Moreover, we might collect the personal data you
                provide to us (including but not limited to Name, Surname,
                Address, payment information, etc.) during registration to be
              ...
              <p>
                ...
                welcome to contact us via achintya@minovateck.com.
              </p>
